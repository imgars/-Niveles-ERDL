...
// Esquema de Usuario (strict: false permite rankcard_custom y otros campos dinámicos)
const userSchema = new mongoose.Schema({
  ...
  selectedCardTheme: { type: String, default: null },
  purchasedCards: { type: [String], default: [] },
  rankcard_custom: {
